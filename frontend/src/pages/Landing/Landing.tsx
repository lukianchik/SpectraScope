...
const FEATURES = [
        {
                icon: Globe2,
                title: 'Continuous Surface Discovery',
        ...
        },
        {
                ...
                text: 'Every scan launch writes a tamper-evident audit record. Liveness, readiness and Prometheus metrics included.',
        },
];
        ...
        return (
                <div className={styles.landing} data-testid="landing-page">
                        ...
                        <section className={styles.hero}>
                                <div className={styles.heroLeft}>
                                        <span className={styles.tag}>
                                                <span className={styles.dot} /> v0.1 · safe-by-default
                                        </span>
                        ...
                        <footer className={styles.footer}>
                                <span>SPECTRASCOPE · v0.1 · MVP</span>
