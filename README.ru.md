...
Это однопользовательский портфолио-проект, а не готовый multi-tenant SaaS. Для публикации в интернете нужны TLS, уникальные секреты, резервное копирование, правила хранения данных и независимая проверка безопасности. Подробнее — в [SECURITY.md](SECURITY.md).
